...
<?php if (have_posts()) : the_post(); update_post_caches($posts); ?>
	...
	<div class="post" id="post-<?php the_ID(); ?>">
		<h2>
			<?php if ( $user_ID ) : ?>
				<div class="act">
					<span class="addlink"><a href="<?php echo get_settings('siteurl'); ?>/wp-admin/link-add.php"><?php _e('Add link', 'Julie'); ?></a></span>
					<span class="editlinks"><a href="<?php echo get_settings('siteurl'); ?>/wp-admin/link-manager.php"><?php _e('Edit links', 'Julie'); ?></a></span>
				</div>
			<?php endif; ?>
			<?php the_title(); ?>
		</h2>
