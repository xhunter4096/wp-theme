...
<div id="navigation">
	<!-- menus START -->
	<ul id="menus">
		<li class="<?php echo($home_menu); ?>"><a class="home" title="<?php _e('Home', 'Julie'); ?>" href="<?php echo get_settings('home'); ?>/"><?php _e('Home', 'Julie'); ?></a></li>
		<?php
...
//<![CDATA[
	...
	var tiptext = "<?php _e('Type text to search here...', 'Julie'); ?>";
